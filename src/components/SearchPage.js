...
const mockData = [
    {
        name: "Flowchart and concept mapping",
        desc: "Flowchart Mapping - Involves creating a flow model that contains a concept, item or question for exploring knowledge, new information, new ideas, or relationships. Flowchart Map Definitions and Objectives. A flowchart map illustrates the steps in a process. By visualizing the process, a flowchart can quickly help identify bottlenecks or inefficiencies where the process can be streamlined or improved. A drawing that uses symbols interconnected with lines to represent the flow of information. A process flow diagram that illustrates the successive steps in a process, procedure, system or model.",
        tags: ["Free", "Free (students)", "University", "Video camera", "Computer"],
    },
    {
        ...
        tags: ["Free", "Free (students)", "University", "Requires hardware", "Video camera", "OSX", "Windows"],
    },
    {
        name: "Screencasting",
