        ...
        <div className="row justify-content-center align-items-center">
          <div className="col-md-5">
            ...
            <p className="bodyText">
              There are references to research literature and
              ...
              methodologies. This does not only get education more effective. It also makes it more fun!
            </p>
          </div>
    ...
    return (
      <div className="row justify-content-center align-items-center">
        ...
        <div className="col-md-5">
          ...
          <h1>What is T.L.T?</h1>
          <p className="bodyText">
              T.L.T. - Teaching and Learning Technology is a website at
              ...
              teaching methods that can help enhance student learning.
          </p>
        </div>
      </div>
    );
