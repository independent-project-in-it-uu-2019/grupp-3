...
By exploiting the positive feedback we usually get from tapping
                        around with our phone or computer in education, learning does not
                        only get more effective. It also makes it more fun!
    ...
    return (
      <div className="row justify-content-center align-items-center">
            ...
            <div className="col-md-5">
                ...
                <p className="bodyText">
N.E.F.T is your help to improve your lectures and classes by providing
